...
plt.legend()
plt.tight_layout()
plt.savefig('enrollment_visual_1_trends.png')
...
plt.tight_layout()
plt.savefig('enrollment_visual_2_hotspots.png')
...
plt.legend()
plt.tight_layout()
plt.savefig('enrollment_visual_3_anomalies.png')
...
plt.tight_layout()
plt.savefig('enrollment_visual_4_correlation.png')
...
plt.tight_layout()
plt.savefig('enrollment_visual_5_pareto.png')
...
plt.tight_layout()
plt.savefig('enrollment_visual_6_composition.png')
