...
plt.legend()
plt.tight_layout()
plt.savefig('biometric_visual_1_trends.png')
...
plt.tight_layout()
plt.savefig('biometric_visual_2_bottlenecks.png')
...
plt.tight_layout()
plt.savefig('biometric_visual_3_correlation.png')
...
plt.tight_layout()
plt.savefig('biometric_visual_4_pareto.png')
...
plt.tight_layout()
plt.savefig('biometric_visual_5_split.png')
