...
file_path = '../../data/raw/enrolment.csv'
...
# 4. EXPORT
# ---------------------------------------------------------
monthly_df.to_csv('../../data/processed/cleaned_monthly_enrollment_data.csv', index=False)
print("\nSuccess! Saved to '../../data/processed/cleaned_monthly_enrollment_data.csv'")