...
file_path = '../../data/raw/demographics.csv'
...
monthly_df.to_csv('../../data/processed/cleaned_monthly_uidai_data.csv', index=False)
print("\nSuccess! Saved cleaned data to '../../data/processed/cleaned_monthly_uidai_data.csv'")